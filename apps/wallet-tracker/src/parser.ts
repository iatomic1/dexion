...
function getAssetContractId(pc: PostCondition): string {
  ...
  if (pc.type === "fungible") return `${pc.asset.contract_address}.${pc.asset.contract_name}`;
  return "Unknown";
}
    ...
    if (
      ...
      if (
        ...
        return {
          ...
          action: "Swap",
          details: {
            sent: { asset: sentAsset, amount: sentAmount, contractId: sentContractId },
            received: { asset: receivedAsset, amount: receivedAmount, contractId: receivedContractId },
          },
      ...
      if (function_name === "deposit") {
        ...
        if (sent) {
          ...
          return {
            ...
            protocol,
            action: "Deposit",
            details: { sent: { asset: "STX", amount: sentAmount, contractId: STX_CONTRACT_ID } },
    ...
    if (protocol === "Zest") {
      ...
      if (function_name === "supply" && sent) {
        ...
        return {
          ...
          protocol,
          action: "Supply",
          details: { sent: { asset: sentAsset, amount: sentAmount, contractId: sentContractId } },
