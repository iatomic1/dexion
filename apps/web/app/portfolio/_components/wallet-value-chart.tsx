...
//
// // Custom tooltip component that fixes the type issue
...
//   // Add null check for walletData
//   // Calculate the current portfolio value
//   const currentValue = React.useMemo(() => {
//     if (walletData.length === 0) {
//       return 0;
//     }
//     return walletData[walletData.length - 1].value;
//   }, []);
//
//   // Add null check for dates
//   const startDate = React.useMemo(() => {
//     if (walletData.length === 0) return new Date();
//     return new Date(walletData[0].date);
//   }, []);
//
//   const endDate = React.useMemo(() => {
//     if (walletData.length === 0) return new Date();
//     return new Date(walletData[walletData.length - 1].date);
//   }, []);
//
//   return (
//     <Card className="">
