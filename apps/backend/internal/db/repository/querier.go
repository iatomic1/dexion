...
type Querier interface {
	ActivateAlert(ctx context.Context, arg ActivateAlertParams) (*Alert, error)
	...
	PauseAlert(ctx context.Context, arg PauseAlertParams) (*Alert, error)
	TrackWalletTelegram(ctx context.Context, arg TrackWalletTelegramParams) (*TelegramUserWallet, error)
	TriggerAlert(ctx context.Context, arg TriggerAlertParams) (*Alert, error)
