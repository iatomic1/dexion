...
export const ADD_WALLET_PROMPT =
	"Please use the /track command to add a new wallet.";
export const DELETE_WALLET_PROMPT =
	"Please use the /untrack command to delete a wallet.";
...
export const DELETE_ALERT_PROMPT =
	"Please use /deletealert <alert_id> to remove an alert.";
...
// Keyboards
export const preferenceKeyboard = (walletAddress: string) =>
...
export const globalSettingsKeyboard = Markup.inlineKeyboard([
	Markup.button.callback("Mempool (Instant)", "set_preference_mempool"),
	Markup.button.callback("Confirmed (Reliable)", "set_preference_confirmed"),
]);

export const listKeyboard = Markup.inlineKeyboard([
	[
		Markup.button.callback("✨ Add", "add_wallet"),
		Markup.button.callback("🗑️ Delete", "delete_wallet"),
	],
